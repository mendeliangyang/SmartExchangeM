...
//    public static Set<BycycleDataModel> bicycleSet = null;
    ...
    public static String getVersionPath() throws Exception {
        if (versionPath == null) {
            versionPath = new StringBuffer().append(getDelplyRootPath()).append(File.separator).append("zstData")
    ...
    public static String getBicycleDataPath() throws Exception {
        if (bicycleDataPath == null) {
            bicycleDataPath = new StringBuffer().append(getDelplyRootPath()).append(File.separator).append("zstData")
